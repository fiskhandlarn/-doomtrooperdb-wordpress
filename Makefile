...
ssl%create:
	@openssl req -x509 -nodes -days 3650 -newkey rsa:2048 -subj "/C=DE/ST=Luna/L=Luna/O=doomtrooperdb/CN=localhost" -keyout $(SSL_CERTS_DIR)/server.key -out $(SSL_CERTS_DIR)/server.pem
